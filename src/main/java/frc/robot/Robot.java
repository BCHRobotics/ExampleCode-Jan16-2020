...
public class Robot extends TimedRobot {
  ...
  public void teleDrive(){
    ...
    y = m_oi.driveStick.getRawAxis(RobotMap.OI_DRIVESTICK_MOVEY);
    turn = m_oi.driveStick.getRawAxis(RobotMap.OI_DRIVESTICK_TURN);

    if(y < deadzone || y > -deadzone) y = 0;
    if(turn < deadzone || turn > -deadzone) turn = 0;
